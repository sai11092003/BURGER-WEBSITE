...
import { createBurger } from '../../actions/burgerActions';
...
const CreateBurgerForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            dispatch(createBurger(burgerdata, user.token,navigate));
        } catch (error) {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
                <h2 className="text-2xl font-bold mb-6 text-center">Create a New Burger</h2>
...
export default CreateBurgerForm;
